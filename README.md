# attention-study
This is an attention study that starts from the original repo associated with **"gSASRec: Reducing Overconfidence in Sequential Recommendation Trained with Negative Sampling"**.
